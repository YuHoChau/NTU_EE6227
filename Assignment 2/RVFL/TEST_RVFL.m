...
% .mat file)
train_set = load('MatDataset\statlog-german-credit\statlog-german-credit_Test.mat');
test_set = load('MatDataset\statlog-german-credit\statlog-german-credit_Train.mat');

% Parameters
ModelParameters.L = 1;                 % Number of layers [int]
...
ModelParameters.Activation = "sigmoid";    % Activation function ['relu','sigmoid']
